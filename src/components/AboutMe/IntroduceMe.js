...
export class IntroduceMe extends React.Component {
  render(){
    return (
      <section className="container-fluid bg-light" id="aboutMe">
        <div className="container">
          <div className="row">
            <div className="col-sm d-sm-flex align-items-center justify-content-center flex-sm-column text-sm-left">
              ...
              <br/>
              <h4>
                You can call me Hawk. Im a, non-top, but decent web developer who you may look for.
              </h4>
              <h6>
              ...
              <button className="btn btn-primary mt-2 dominating-color">Find Out More About Me</button>
            </div>
