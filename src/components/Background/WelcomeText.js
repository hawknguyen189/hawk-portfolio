      ...
      <div className="container text-center">
        <div className="row">
          <div className="col-sm-6 text-white">
            ...
            <h3 className="text-left">Light Tomorrow With Today</h3>
            <h4 className="text-left">
              It does not matter how slowly you go as long as you do not stop. – Confucius
            </h4>
          </div>
          <div className="col-sm-6 text-white rounded align-middle d-flex flex-column align-items-center justify-content-center" style={style}>
