const ProjectCollection1 = [
  ...
  {
    websiteId: "loopMondo",
    websiteName: "Loop Mondo",
    websiteImage: "loopmondo",
    websiteContent:
      "It's a portfolio site for the Loopmondo Group. The site utilizes Gatsby, D3, and so on.",
    websiteIntro:
      "Together with 2 other founders, we founded LoopMondo Ltd to help bridge the connection betwene Vietnam & Canada.",
    websiteLink: "https://loopmondo.com/",
    websiteGit: "https://github.com/hawknguyen189/loop-global",
    responsiveImage: "mockup-loopmondo.png",
    techonologies: ["Gatsby", "D3 Data-Driven Documents", "Boostrap 5"],
    extra: `This's my first time using Gatsby template generator and D3 for visualizing chart & data.`,
  },
];
const ProjectCollection2 = [
  {
    websiteId: "treoBamboo",
    websiteName: "TreoBamboo Store",
    websiteImage: "treobamboo",
    websiteContent:
      "This is a shopify site. As per request from the client, I help maintain the frontend and add new features.",
    ...
    to read over their documentation.
    As Shopify only offers frontend access, I do spend time on finding a work-around solution for almost every new feature.
    Also, debugging on shopify really did me much pain.`,
  },
  {
  ...
  },
  {
    ...
    extra: `Started as a new open-source side project of Andre Cronje, I developed the UI site to interact with the smart contract on fantom blockchain.
