        ...
        <div className="container py-5">
          <div className="row">
            <div
              ...
              flex-sm-column py-4"
            >
              <h3 className="border-bottom">My Project Pets</h3>
            </div>
          </div>
          <div className="row py-3">
            <div
              className="col-sm-7 d-sm-flex align-items-center justify-content-center
              ...
              <div className="row py-3">
                <div className="col border rounded border-dominating-color border-width-small mx-1 px-0 ">
                  <a
                    ...
                    className="w-100 project-button align-items-center justify-content-center d-flex"
                ...
                <div
                  className="col border rounded border-dominating-color border-width-small mx-1 px-0"
                  rel="noopener noreferrer"
                >
                  <a
                    href={this.props.websiteGit}
