...
import {
  ProjectCollection1,
  ProjectCollection2,
} from "../components/Project/ProjectCollection";
        ...
        <div className="container">
          <div className="row">
            <div
              ...
              flex-sm-column wow"
            >
              <h3 className="border-bottom px-2">My Latest Work</h3>
              <p>Some of my latest projects love to be shown here</p>
            </div>
          </div>
          <div
            className="row py-5 wow zoomInDown"
